    ...
    <View>
      {isLoading ? (
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          />
          {/* {videosGallary.length? <VerticalBigList  data={data} /> : null} */}
          {videosGallary.length ? (
            <VerticalBigList videosRightGallary={videosRightGallary} />
          ) : null}
          {/* {
      console.log('data is  videosRightGallary........', videosRightGallary)
    }
     {
...
const HomeYoutubVideosInsideCom = ({route, data}) => {
  const [isLoading, setIsLoading] = useState(false);
